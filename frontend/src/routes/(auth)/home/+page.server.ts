...
// WorkoutHeader.svelte (Workstream C) consume `data.user` to show a real name/email
// in the Live Studio header instead of the old mock `userManager`/`PRESET_USERS`.
